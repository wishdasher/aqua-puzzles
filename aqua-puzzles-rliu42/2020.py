...
preface = {
    ...
    "7": "The answer is NO.",
    "8": "The answer is YES.",
    "9": "This answer is YES.",
    "10": "The answer is MAYBE ;D"
}

# Enter the clue text given for a correct answer
storyline = {
    "1": "The EECS major is teaching her pet Beaver how to code.",
    "2": "Rosalind is a Biology major - she's already made some groundbreaking discoveries.",
    "3": "Did you know that Marie owns a pet Turtle?",
    "4": "The McCormick resident spends a lot of time crunching code in Stata.",
    "5": "The Chemistry major enjoys the quietude of Barker Library.",
    "6": "The MacGregor resident owns a Manatee.",
    "7": "Albert was found admiring the view atop the Green Building.",
    "8": "Ask the New House resident 8.01 pset help - he studies Physics.",
    "9": "Ivan lives in Next House - he really enjoys all those long walks.",
    "10": ""
}

client = MongoClient()
db = client.splash2016_2
teams = db.teams
...
stock_messages = {
    "Welcome": "Welcome to the SPLASH investigation, {team_name}! Start texting us with answers [MYSTERY CASE NO] [SOLUTION], like '1 sherlock'",
    "Help": "Text [MYSTERY CASE NO] [SOLUTION], like '1 sherlock', and we'll let you know if you are correct.",
    #"Help": "Text [MYSTERY CASE NO] [SOLUTION], like '1 sherlock', and we'll let you know if you are correct. If you need more help, venture down to Front Desk or find a staff member wearing a top hat.",
    ...
    "Name Too Long": "Sorry, please keep your name under 20 characters. Text 'yes' to accept the name '{team_name_temp}' or text to create a new one.",
    "Text Way Too Long": "You're wasting your valuable investigation time. Please refrain from sending such long-winded messages.",
    ...
    "Parse Error": "Sorry, we didn't understand '{text}'. Please text answers in the format [MYSTERY CASE NO] [SOLUTION], like '1 sherlock'. You can also ask the teachers for hints!",
    "Problem Not Exists": "There is no Mystery Case No. {puzzle_number}...",
    "Correct": "With your solution {answer} you've solved Mystery Case No. {puzzle_number}: {storyline} {preface}",
    "Incorrect": "Sorry, your answer {answer} for Mystery Case No. {puzzle_number} was incorrect.\nPlease try again (you can also ask the teachers for hints)",
    "Already Answered": "You've already solved Mystery Case No. {puzzle_number}: {storyline} {preface}",
    "Final Puzzle": "{preface} With your solution {answer}, you've solved Mystery Case No. {puzzle_number}: {storyline} Congrats on solving all the mystery cases {team_name}! You should be ready to take on the META mystery now!",
    "Meta Correct": "Well done {team_name}! With your answer {answer} you've solved the final META mystery! This concludes the puzzlehunt, congrats!",
    "Meta Answered": "What are you still doing wasting your valuable investigation time?",
...
special_messages = {
    ...
    "8": {
        "PHYSICISTS": "You've got the right letter.. but PHYSICISTS is not the correct answer.",
        "P": "Good progress.. but P is not the final answer. Remember, all solutions are English words."
    },
    "9": {
        "PQRST": "Good progress.. but PQRST is not the correct answer. Hint: we're looking for a chemical compound.",
        "HIJKLMNO": "Good progress.. but HIJKLMNO is not the final answer. As the title indicates, we're looking for a chemical compound name.",
